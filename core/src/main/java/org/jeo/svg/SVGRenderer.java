...
import org.jeo.map.render.AnchoredLabel;
...
public class SVGRenderer extends BaseRenderer implements Labeller {
    ...
    public SVGRenderer(OutputStream output) throws IOException {
        this.output = output;
    ...
    public void init(View view) {
        ...
        try {
            ...
            window = new Envelope(0, view.getWidth(), 0, view.getWidth());
        } catch (IOException e) {
    ...
    @Override
    protected void drawPoint(Feature f, Rule rule) {
        ...
        if (label != null) {
            ...
            AnchoredLabel l = new AnchoredLabel(label, rule, f, point, a);
    ...
    public boolean layout(Label label, LabelIndex labels) {
        if (label instanceof AnchoredLabel) {
            return layout((AnchoredLabel)label, labels);
        }
        return false;
    }

    boolean layout(AnchoredLabel label, LabelIndex labels) {
        ...
        Coordinate anchor = label.getAnchor();
    ...
    public void render(Label label) {
        ...
        if (label instanceof AnchoredLabel) {
            render((AnchoredLabel)label);
        }
    }

    void render(AnchoredLabel label) {
